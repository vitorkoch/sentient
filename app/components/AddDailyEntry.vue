	...
	<UCard class="w-150 max-w-full m-auto p-2">
		...
		<template #footer>
			<div class="flex flex-row gap-5 items-center justify-center">
				<UButton label="Cancelar" variant="soft" color="neutral" size="xl" :icon="ui.icons.close" @click="todayEntry.mood = undefined" />
				<UButton label="Confirmar" variant="solid" color="primary" size="xl" :icon="ui.icons.check" loading-auto @click="handleConfirm" />
			</div>
		</template>
	</UCard>
</template>
